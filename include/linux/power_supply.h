...
enum power_supply_property {
	...
	/*add sc8551 node for check chip vendor,because maxim IIC address have conflict with sc8551.*/
	...
	POWER_SUPPLY_PROP_APSD_TIMEOUT,
       //refine of maxim,so resume this
...
typedef enum _NOPMI_CHARGER_IC_TYPE{
	NOPMI_CHARGER_IC_NONE,
	NOPMI_CHARGER_IC_MAXIM,
	NOPMI_CHARGER_IC_SYV,
	NOPMI_CHARGER_IC_SC,
	NOPMI_CHARGER_IC_MAX
}NOPMI_CHARGER_IC_TYPE;
#endif
